...
const ChatPlaceholder = () => {
  return (
    ...
    >
      ...
      <h1
        className="absolute text-[120px] md:text-[160px] font-black text-gray-300 opacity-20 select-none animate-echo-float z-0"
        style={{
      ...
      <div className="z-10 text-center">
        <h2 className="text-2xl text-gray-700 font-semibold">Select a conversation to chat</h2>
